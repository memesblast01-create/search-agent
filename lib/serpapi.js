...
// Maps common country names/abbreviations to Google's two-letter country
// code (the "gl" param). This scopes results to that country's entire
// Google index — not a single city/region — so the whole country gets
// scanned rather than wherever a "location" string happens to anchor to.
const COUNTRY_TO_GL = {
  "uae": "ae",
...
// Restricts Google itself to only show pages it considers published/updated
// in the last N days — on top of our own date filtering on structured
// ATS data in the extraction layer.
